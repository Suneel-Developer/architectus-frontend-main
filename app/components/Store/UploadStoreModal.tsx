      ...
      <div className="bg-white rounded-[20px] p-5 md:p-7 w-full mx-auto max-w-[600px] relative min-h-full">
        ...
        <div className="h-[90vh] overflow-y-scroll overflow-x-hidden formscrollbar">
          ...
          <div className="flex flex-col gap-y-4">
            ...
            <button className="bg-gradient mt-4 text-white rounded-[10px] w-full min-h-12 md:min-h-[52px] text-center px-3 text-sm md:text-lg tracking-[2%] font-medium transition-opacity duration-300 hover:opacity-90">
              Submit Request
            </button>
