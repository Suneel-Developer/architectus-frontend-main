...
const SportsProducts: React.FC = () => {
  ...
  return (
    <div className="mb-12">
            ...
            <div className="shadow-2 bg-white rounded-2xl md:rounded-[20px] overflow-hidden  mb-14 md:mb-20">
                ...
                <div className="flex items-center w-full justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="text-[#0F1017] text-sm md:text-xl font-semibold">
                      <span className="text-2xl">@</span>{coach.name}
                    </h2>
                  </div>
              ...
              <div className="mt-6 pb-7 px-4 md:px-8">
                <div className="flex flex-col gap-6">
                  {/* Video With title  */}
                  <div className="max-w-[600px] w-full mx-auto mb-2">
                    <div className="rounded-lg overflow-hidden h-[200px] md:h-[350px] mb-4">
                      {isPlayingFirst ? (
                        <video
                          ref={videoRefFirst}
                    ...
                    <h2 className="text-[#0F1017] text-base md:text-lg font-semibold mt-5">
                      {coach.videotitle1}
                    </h2>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-5 items-start md:items-center">
                    ...
                    <div className="flex gap-4 items-center">
                      ...
                      <button onClick={handleOpenCreateSend}
                        className="shadow-3 w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 hover:border-[#3D2278]"
                      >
      ...
      {isOpenCreateSendModal && <CreateSendModal onClose={handleCloseCreateSend} onCreate={handleOpenVeriicationModal} />}
      {isOpenVeriicationModal && <VerificationLoadingModal onClose={handleCloseVeriicationModal} />}
